...
class OpenApiContractsVerifierMatrixTest {
    ...
    @CsvSource(textBlock = """
            ...
            openapi/verify_contract_validation.yml, contracts/validation_matrix/java/invalid
            ...
            openapi/verify_contract_validation.json, contracts/validation_matrix/java/invalid
            """)
